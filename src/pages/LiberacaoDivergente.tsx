...
type LiberacaoDivergenteProps = {
  onNavigateToFaturamentoCS?: () => void;
};

export function LiberacaoDivergente({ onNavigateToFaturamentoCS }: LiberacaoDivergenteProps) {
  const { t } = useLanguage();
  ...
  return (
    <section
      aria-labelledby="liberacao-divergente-heading"
      className="mx-auto flex w-full max-w-5xl flex-col gap-8"
    >
      <header className="flex flex-wrap items-center justify-between gap-4">
        <h1
          id="liberacao-divergente-heading"
          className="text-3xl font-medium text-primary"
        >
          {t("page.liberacao-divergente")}
        </h1>
      ...
      <div className="rounded-2xl border border-borderNeutral bg-white px-6 py-5 shadow-sm">
                      ...
                      <td className="py-3 px-2">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="flex size-6 items-center justify-center rounded border border-borderNeutral transition hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            <Minus size={14} />
                          </button>
        ...
        <div className="mt-8">
          ...
          <textarea
            ...
            placeholder={t("field.comentario")}
            rows={4}
